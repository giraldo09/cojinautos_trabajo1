...
import pandas as pd
from cojinautos_insert import insert_data_cojinautos  # Asegúrate de que esta importación funcione
...
# Combine the data using merge when both files are uploaded
if df_clients is not None and df_services is not None:
    if st.button("Merge Files"):
        try:
            # Merge the two dataframes on 'IDCustomer'
